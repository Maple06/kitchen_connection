export const renderAccount = async (container) => {
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="col-span-1">
            ...
            <div class="mt-6 bg-red-50 rounded-2xl border border-red-100 p-6 text-center">
              ...
              <button id="req-delete-btn" class="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg font-medium transition-colors text-sm">
                Ajukan Hapus Akun
              </button>
          ...
          <div class="col-span-1 md:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <form id="cp-form" class="space-y-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Sandi Lama</label>
                  <div class="relative">
  ...
  if (reqDeleteBtn) {
    reqDeleteBtn.addEventListener('click', async () => {
      ...
      try {
        const res = await fetch('http://localhost:5000/api/account/request-delete', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          credentials: 'include'
        });
